...
Email routing for getrf.id only. Uses existing verified destination `miks2u+trakrf@gmail.com`.
...
Note: `local.catchall_email` is defined in main.tf as `miks2u+trakrf@gmail.com` — reuse it directly.
...
- Send test email to az1@getrf.id → should arrive at miks2u+trakrf@gmail.com
