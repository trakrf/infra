...
- Rule correctly references both destinations:
  - miks2u+trakrf@gmail.com
  - stephen.maliszewski@jci.com
...
1. **Cloudflare Dashboard → Email Routing → Destination Addresses**
   - Verify `stephen.maliszewski@jci.com` appears
...
**Resources Created**:
1. `cloudflare_email_routing_address.jci_stephen` - Verified destination for stephen.maliszewski@jci.com
