...
## Outcome
Emails sent to `peter@trakrf.id` will be routed to `peter.stankavich@gmail.com` via Cloudflare Email Routing.
...
**Desired**: Add `peter@trakrf.id` → `peter.stankavich@gmail.com` as a new individual alias, following the same pattern as tim@ and nick@.

## Technical Requirements
- Register `peter.stankavich@gmail.com` as a verified destination address (`cloudflare_email_routing_address`)
...
- [ ] Cloudflare sends verification email to `peter.stankavich@gmail.com`
- [ ] After verification, emails to `peter@trakrf.id` are delivered

## Conversation References
- User request: "i want to add another alias peter@ for peter.stankavich@gmail.com"
